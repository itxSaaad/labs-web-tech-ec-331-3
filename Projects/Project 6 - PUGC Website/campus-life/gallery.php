        ...
        <ul>
          ...
          <li class="dropdown">
            ...
            <ul>
              ...
              <li>
                <a href="../academics/programs.php">Programs</a>
              </li>
              <li>
                <a href="../academics/faculty.php">Faculty</a>
              </li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul>
              <li>
                <a href="../campus-life/facilities.html">Facilities</a>
              </li>
              ...
              <li>
                <a href="../campus-life/gallery.php" class="active">Gallery</a>
              </li>
            </ul>
          </li>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Gallery</h1>
              <p class="mb-0">
                Explore the campus life through our gallery of images
              </p>
            </div>
          </div>
        </div>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Campus Life</li>
            <li class="current">Galley</li>
          </ol>
        </div>
      </nav>
    </div>
      ...
      <div class="container">
        <div class="row g-4">
          ...
          for ($i = 1; $i <= 23; $i++) {
            ...
            <div class='card'>
              <img
                src='../assets/img/gallery/g{$i}.jpeg'
                class='card-img'
                alt='Gallery Image g{$i}'
              />
            </div>
          </div>";
          }
