        ...
        <ul>
          ...
          <li class="dropdown">
            ...
            <ul>
              ...
              <li>
                <a href="../academics/programs.php" class="active">Programs</a>
              </li>
              <li>
  ...
  <main class="main">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">
                Explore the programs offered by the University of the Punjab,
                Gujranwala Campus
              </p>
            </div>
          </div>
    ...
    <section id="courses" class="courses section">
      <div class="container">
        <div class="row">
          <?php
          $sql = "SELECT p.name, p.description, p.image_path, d.name AS department_name 
        FROM programs p 
        JOIN departments d ON p.department_id = d.id";
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo '<p class="category">Department of ' . $row['department_name'] . '</p>';
              echo '</div>';
              echo '<h3>' . $row['name'] . '</h3>';
